            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Add Test <small>Add your Test from here</small></h2>
                                    ...
                                    <div class="row m-auto">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-4 col-sm-3 label-align" for="name">Test Name <span class="required"></span>
                                                </label>
