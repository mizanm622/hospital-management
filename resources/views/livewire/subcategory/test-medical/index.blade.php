<div class="col-md-12 col-sm-12">
    <div class="x_panel">
       @include('livewire.subcategory.test-medical.modal_form')

        <div class="x_title">
                <h2> <a href="" class="btn btn-md btn-primary" data-toggle="modal" data-target=".add-modal">+Add Test</a> Test List<small>Show Test list from here</small></h2>
